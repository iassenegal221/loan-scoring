...
def load():
    ...
    import io
    import requests
    model_url = "https://github.com/Alhasdata/loan-scoring/blob/main/app/data/training_features.pkl"#"https://github.com/Alhasdata/loan-scoring/raw/main/app/models/best_model.pkl"
